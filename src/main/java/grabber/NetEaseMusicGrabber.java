...
public class NetEaseMusicGrabber extends Grabber {
	...
	public void main() throws IOException, WebApiException, InvalidPlaylistURLException, NoneInPlaylistException {
		...
		// api description https://www.dongyonghui.com/default/20180128-ÍøÒ×ÔÆ¡¢¿á¹·¡¢QQÒôÀÖ¸èµ¥½Ó¿ÚAPI.html
		URL reqUrl = new URL("https://api.hibai.cn/api/index/index");
		String TransCode = "020111";
